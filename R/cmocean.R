...
#'    in the colormap.
#' * topo: The topo colormap has two distinct parts: one that is
#'    shades of blue and yellow to represent water depths (this is the
#'    \code{\link{deep}} colormap) and one that is shades of browns
#'    and greens to represent land elevation.
#' * balance: diverging with dark blue to off-white to dark red
...
#' * delta: diverging from darker blues to just off-white
...
#'    \sQuote{viscm} tool.
#' * curl: diverging from darker teal to just off-white through
#'    shades of magenta and could be used to represent diverging
#'    vorticity values around a critical value (usually zero).
#' * cmdiff: The diff colormap is diverging, with one side
#'    shades of blues and one side shades of browns.
#' * tarn: diverging, with one side dry shades of browns and
